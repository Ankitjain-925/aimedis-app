    ...
    <PageLayout
      ...
      {!openForm ? (
        <Box
          ...
          borderRadius="8px">
          <Box mb="12px">
            <Text mb="8px" fontSize="14px" fontWeight="500">
              Select Hospital
            </Text>
        ...
        <>
          <Box
            ...
            <Box mb="20px">
              ...
              <Text mb="5px" fontSize="ms" fontWeight="600">
                Blood Pressure
              </Text>
            ...
            <Box mb="20px">
              <Stack direction={["row", "row"]} spacing="24px">
                <Box w="100%">
                  <Text fontSize="15px" fontWeight="600">
                    Diameter Leg
                  </Text>
                </Box>
                <Button colorScheme="teal" size="sm" w="44px">
                  Yes
                </Button>
                <Button colorScheme="teal" size="sm" w="44px">
                  No
            ...
            <Box mb="20px">
              <Stack direction={["row", "row"]} spacing="24px">
                ...
                <Button colorScheme="teal" size="sm" mx="5px" w="44px">
                  Yes
                </Button>
                <Button colorScheme="teal" size="sm" mx="5px" w="44px">
                  No
            ...
            <Box mb="20px">
              ...
              <Stack direction={["column", "row"]} spacing="24px">
                <RadioGroup name="form-name">
                  <Radio mx="5px" value="1" colorScheme="teal">
                    Better
                  </Radio>
                  <Radio mx="5px" value="2" pl="40px" colorScheme="teal">
                    Worse
                  </Radio>
                </RadioGroup>
              </Stack>
            ...
            <Box mb="20px">
              <Box mb="10px" w="80%">
                ...
                <Text mb="5px" fontSize="13px" fontWeight="500">
                  ask for incidents
                </Text>
                <Checkbox size="md" colorScheme="teal" defaultChecked>
                  Did you fall today
                </Checkbox>
                <Text mb="5px" fontSize="13px" fontWeight="500" mt="10px">
                  Use of tools
                </Text>
                <Checkbox size="md" colorScheme="teal" defaultChecked>
            ...
            <Box mb="20px">
              <Box mb="10px" w="80%">
                ...
                <Text mb="5px" fontWeight="500" fontSize="13px">
                  ask for incidents
                </Text>
              </Box>
              <Input placeholder="Basic usage" />
              ...
              <Box>
                ...
                <RadioGroup onChange={setValue} value={value} mt="10px">
                  <Stack direction="row">
                    ...
                    <Radio colorScheme="teal" value="2" pl="40px">
                      No
                    </Radio>
                  </Stack>
                </RadioGroup>
            ...
            <Box mb="10px">
              ...
              <Text mb="5px" fontSize="15px" mt="20px" fontWeight="600">
                Amount of wounds
              </Text>
            ...
            <Box mb="20px" mt="20px">
              ...
              <RadioGroup>
                ...
                <Radio w="100%" mb="5px" value="2" colorScheme="teal">
                  Can manipulate an eating device, usually a spoon, but someone
                  must provide active assistance during the meal.
                </Radio>
                ...
                <Radio w="100%" mb="5px" value="4" colorScheme="teal">
                  Independence in feeding with prepared tray, except may need
                  meat cut, milk carton opened or jar lid etc. The presence of
                  another person is not reauired.
                </Radio>

                <Radio w="100%" mb="5px" value="5" colorScheme="teal">
                  The patient can feed self from a tray or table when someone
                  puts the food within reach. The patient must put on an
                  assistive device if needed, cut food, and if desired use salt
            ...
            <Box mb="20px">
              ...
              <RadioGroup>
                <Radio w="100%" mb="5px" value="1" colorScheme="teal">
                  Unable to participate in a transfer. Two attendants are
                  required to transfer the patient with or without a mechanical
                  device.
                </Radio>

                <Radio w="100%" mb="5px" value="2" colorScheme="teal">
                  Able to participate but maximum assistance of one other person
                  is require in all aspects of the transfer.
                </Radio>

                <Radio w="100%" mb="5px" value="3" colorScheme="teal">
                  The presence of another person is required either as a
                  confidence measure, to provide supervision for safety.
                </Radio>

                <Radio w="100%" mb="5px" value="4" colorScheme="teal">
                  The patient can safety approach the bed walking or in a
                  wheelchair, look breaks, lift footrest, or position walking
                  aid, move safely to bed, lie down, come to a sitting position
                  on the side of the bed, chnage the position of the wheelchair,
                  transfer back into it safely.
                </Radio>

                <Radio w="100%" mb="5px" value="5" colorScheme="teal">
                  The patient must be independent in all phases of this
                  activity.
                </Radio>
              </RadioGroup>
            </Box>
            ...
            <Box mb="20px">
              ...
              <RadioGroup>
                ...
                <Radio w="100%" mb="5px" value="4" colorScheme="teal">
                  ...
                  metres yards without help, or supervision in needed for
                  confidence or safety in hazardous situations.
                </Radio>

                <Radio w="100%" mb="5px" value="5" colorScheme="teal">
                  The patient must be able to wear braces if required, lock and
                  unlock these braces assume standinq position, sit down and
                  place the necessary aids into position for use. The patient
                  must be able to crutches, canes, or a walkarette, and walk 50
                  meters/yards without help or Supervision.
                </Radio>
              </RadioGroup>
            </Box>
            ...
            <Box mb="20px">
              ...
              <RadioGroup>
                ...
                <Radio w="100%" mb="5px" value="2" colorScheme="teal">
                  ...
                  assistance is required for all other steps of wheelchair
                  management.
                </Radio>
                ...
                <Radio w="100%" mb="5px" value="5" colorScheme="teal">
                  To propel wheelchair independently, the patient must be a able
                  to go around corners, turn around manoeuvre the chair to a
                  table, bed, toilet, etc. The patient must be able to push a
                  chair at least 50 meters and negotiate a Kerb.
                </Radio>
              </RadioGroup>
            </Box>
            ...
            <Box mb="20px">
              ...
              <RadioGroup>
                ...
                <Radio w="100%" mb="5px" value="2" colorScheme="teal">
                  Assistance is required in all aspects of stairclimbing,
                  including assistance with walking aids.
                </Radio>

                <Radio w="100%" mb="5px" value="3" colorScheme="teal">
                  The patient is able to ascend/desend but is unable to carry
                  walking aids and needs supervision and assistance.
                </Radio>

                <Radio w="100%" mb="5px" value="4" colorScheme="teal">
                  Generalyno assistanceis required. At times supervision is
                  required for safety due to morning siftnes, shortness of
                  breath.
                </Radio>

                <Radio w="100%" mb="5px" value="5" colorScheme="teal">
                  The patient is able to go up and down a flight of stairs
                  safely without help or supervision. The patient is able to use
                  hand rails, cane or crutches when needed and is able to carry
            ...
            <Box mb="20px">
              ...
              <RadioGroup>
                ...
                <Radio w="100%" mb="5px" value="5" colorScheme="teal">
                  The patient is able to get on/off the toilet, fasten clothing
                  and use toilet paper without help. if necessary, the patient
                  may use a bed pan or Commode or urinal at night, but must be
                  able to empty it and clean it.
                </Radio>
              </RadioGroup>
            </Box>
            ...
            <Box mb="20px">
              ...
              <RadioGroup>
                ...
                <Radio w="100%" mb="5px" value="2" colorScheme="teal">
                  The patient needs help to assume appropriate position, and
                  with bowel movement facilitatory techniques.
                </Radio>

                <Radio w="100%" mb="5px" value="3" colorScheme="teal">
                  The patient can assume appropriate position, but can not use
                  facilitatory techniques or clean self without assistance and
                  has frequent accident. Assistance is reuired with incontinence
                  aids such as pad, etc.
                </Radio>

                <Radio w="100%" mb="5px" value="4" colorScheme="teal">
                  The patient may require supervision with the use of
                  suppository or enema and has occasional accident.
                </Radio>
            ...
            <Box mb="20px">
              ...
              <RadioGroup>
                <Radio w="100%" mb="5px" value="1" colorScheme="teal">
                  The patient is dependent in bladder management, is
                ...
                <Radio w="100%" mb="5px" value="3" colorScheme="teal">
                  The patient is generally dry by day, but not at night and
                  needs some assistance with the devices.
                </Radio>

                <Radio w="100%" mb="5px" value="4" colorScheme="teal">
                  The patient is generally dry by day and night, but may have an
                  occasional accident or need minimal assistance with internal
                  or external devices.
                </Radio>

                <Radio w="100%" value="5" colorScheme="teal">
                  The patient is able to control bladder day and night, and/or
                  is independent with internal or external devices.
                </Radio>
              </RadioGroup>
            </Box>
